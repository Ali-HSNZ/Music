                ...
                {sliders.map((item,index) => (
                  <SwiperSlide key={index}>
                    <div className="relative max-w-[200px] min-w-[200px]">
                         ...
                         <Link href={'/song'} className='mt-2 p-2 relative pl-9 flex items-center justify-start border group border-secondBg duration-150 hover:border-second h-auto rounded-md border-secondColor'>
                              {type === ETypes.SINGER ? (
                              ...
                              <p className='w-[148px] text-main truncate ml-2 text-secondColor text-left font-quicksand-medium'>Ye Rooze Khoob Miad!</p>
                         </Link>
                    </div>
                  </SwiperSlide>
                ))}
