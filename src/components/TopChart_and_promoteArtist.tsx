...
const TopChart_and_promoteArtist = () => {
     return (
          <section className='w-full  gap-x-6 '>
               {/* Promote Artist */}
               <div className='min-h-[300px] w-full h-auto py-8 flex flex-col justify-between overflow-hidden bg-[#488292] rounded-lg relative'>
                    <img src={songer.src} className="  max-h-[290px] absolute z-10 right-10 bottom-0 object-cover"/>
                    <img src={vector.src} className=" absolute top-0 right-0 z-1"/>
               ...
               <section className='grid grid-cols-2 gap-x-6'>
                    <div className='w-full mt-6 '>
                         ...
                         <div className='w-full mt-2 flex flex-col gap-y-4 select-none'>
                              {[1,2,3].map(() => (
                                   <article className='flex cursor-pointer group p-4 rounded-lg justify-between bg-black items-center'>
                                        ...
                                        <button className='p-2 border-2 border-secondBg group-hover:border-yellow h-fit rounded-full border-secondColor'>
