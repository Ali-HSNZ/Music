                                        ...
                                        <div className="px-2 mt-4">
                                             <article className={`gap-x-4 full w-[200px] flex flex-col  border border-secondBg rounded-md p-2`}>
                                                  ...
                                                  <Link href={'/singer'} className='my-3 w-fit relative pl-6 flex items-center justify-start'>
                                                       ...
                                                       <p className='w-full underline underline-offset-2 hover:no-underline cursor-pointer truncate ml-2 text-secondColor text-left font-quicksand-medium text-second'>Shayea</p>
                                                  </Link>
                                                  <Link href={'/song'} className='bg-secondBg bg-opacity-25 p-2 w-full relative pl-11 flex items-center justify-start border group border-secondBg duration-150 hover:border-second h-auto rounded-md '>
                                                       ...
                                                       <p className="truncate font-quicksand-regular text-main">Injaneb</p>
                                                  </Link>
                                             </article>
                                        </div>
                              </SwiperSlide>
