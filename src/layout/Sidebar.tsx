     ...
     return (  
          <aside className='col-span-2 sticky h-screen top-[81px] left-6 w-full'>
               <div className="rounded-md overflow-hidden">
                    <div className='p-4 flex gap-x-2 items-center bg-black hover:bg-secondBg'>
                         ...
                         <span className='font-quicksand-medium text-second'>Home</span>
                    </div>
                    <div className='p-4 cursor-pointer flex gap-x-2 bg-black hover:bg-secondBg'>
