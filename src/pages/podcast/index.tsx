          ...
          <Layout>
               <>
                    ...
                    <section className="z-10 relative">
                         ...
                         <h3 className='text-mainColor text-2xl font-quicksand-bold text-main mt-6'>Artists.</h3>
                         <section className="w-full mt-4 h-auto grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
                         {[   "https://cdnmrtehran.ir/media/imgtmp/640f2b0486667.jpg",
                              ...
                              .map((imgSrc,index) => (
                                   <div>
                                        <section className="w-full border border-secondBg rounded-md p-2">
                                             <img className="w-full max-h-[100px] min-h-[120px] object-cover rounded-md" src={imgSrc}/>
                                        </section>
                         ...
                         {/* New Release */}
                         <FreeSlider type={ETypes.POTCAST} sliders={data} title={"Top Related."}/>

                         {/* More Related podcasts */}
                         <h3 className='text-mainColor text-2xl font-quicksand-bold text-main mt-6'>More Related podcasts.</h3>
