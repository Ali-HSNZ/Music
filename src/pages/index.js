    ...
    <Layout>
      <section className='w-full flex flex-col'>
        <section className='w-full flex justify-between gap-x-6 '>
          <div className='w-full py-8 flex flex-col justify-between overflow-hidden bg-[#488292] rounded-2xl  relative h-full'>
            ...
            <h5 className=' ml-10  font-quicksand-light text-blue-50'>Currated playlist</h5>
            <div>
          ...
          <div className='w-full pr-6'>
            ...
            <div className='w-full mt-2 flex flex-col gap-y-2'>
              <article className='flex p-4 rounded-lg justify-between bg-black items-center'>
                ...
                <button className='p-2 border h-fit rounded-full border-secondColor'>
        ...
        {/* <section className='w-full  mt-8'>
          <h3 className='text-mainColor text-2xl font-quicksand-bold'>New Release.</h3>
